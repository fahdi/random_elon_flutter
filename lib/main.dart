...
void main() => runApp(RandomElon());

class RandomElon extends StatelessWidget {
  @override
...
class _HomeScreenState extends State<HomeScreen> {
  ...
  Future<void> getQuote() async {
    String baseUrl = 'http://elonmusk.quotes/wp-json/quotes/v2/get_random';
    try {
